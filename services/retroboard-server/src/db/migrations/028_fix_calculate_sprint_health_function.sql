-- Migration: 028_fix_calculate_sprint_health_function
-- Description: Fix calculate_sprint_health to use the 2-parameter version of calculate_card_sentiment
-- Created: 2026-02-16

-- After migration 026 added the 2-parameter version of calculate_card_sentiment,
-- calling it with 1 parameter became ambiguous. This migration updates
-- calculate_sprint_health to explicitly call the 2-parameter version.
...
WITH sentiment AS (
  SELECT
    AVG(calculate_card_sentiment(c.content, NULL)) AS avg_raw,
    COUNT(*) AS cnt
  FROM cards c
